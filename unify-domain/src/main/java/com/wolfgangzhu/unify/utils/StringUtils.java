...
package com.wolfgangzhu.unify.utils;
...
public class StringUtils {
     ...
     */
    public static boolean regionMatches(final CharSequence cs, final boolean ignoreCase, final int thisStart, final CharSequence substring,
